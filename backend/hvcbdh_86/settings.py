"""
Django settings for hvcbdh_86 project.
...
WSGI_APPLICATION = 'hvcbdh_86.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hvcbdh_86 API",
    "DESCRIPTION": "API documentation for hvcbdh_86 App",
    "VERSION": "v1",
}
